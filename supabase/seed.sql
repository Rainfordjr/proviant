...
-- Raw Materials (expanded fields)
INSERT INTO raw_materials (
  id, org_id, name, vendor_name, item_code, supplier_id, unit, category, item_type, brand,
  cost, packaging_size, storage_requirements, shelf_life_qty, shelf_life_unit,
  opened_shelf_life_qty, opened_shelf_life_unit, allergens, reorder_point, current_stock
) VALUES
  ('d0000000-0000-0000-0000-000000000001', 'a0000000-0000-0000-0000-000000000001',
   ...
   18.50, '50 lb', 'Ambient', 12, 'Months', 6, 'Months', '{wheat}', 100, 500),
  ...
  ('d0000000-0000-0000-0000-000000000004', 'a0000000-0000-0000-0000-000000000001',
   ...
   4.25, '1 gal', 'Refrigerated', 14, 'Days', 7, 'Days', '{milk}', 20, 15),
  ...
  ('d0000000-0000-0000-0000-000000000005', 'a0000000-0000-0000-0000-000000000001',
   ...
   5.80, '1 lb block', 'Refrigerated', 6, 'Months', 14, 'Days', '{milk}', 30, 45),
  ...
  ('d0000000-0000-0000-0000-000000000009', 'a0000000-0000-0000-0000-000000000001',
   ...
   'b0000000-0000-0000-0000-000000000001', 'lbs', 'Raw Material', 'Flour', 'Pacific NW',
   24.00, '50 lb', 'Ambient', 10, 'Months', 4, 'Months', '{wheat}', 40, 25),
  ...
  ('d0000000-0000-0000-0000-000000000011', 'a0000000-0000-0000-0000-000000000001',
   ...
   6.50, '10 lb', 'Ambient', 18, 'Months', 6, 'Months', '{milk,soy}', 50, 150),
  ...
  ('d0000000-0000-0000-0000-000000000012', 'a0000000-0000-0000-0000-000000000001',
   ...
   3.80, '15 dozen case', 'Refrigerated', 28, 'Days', NULL, NULL, '{eggs}', 20, 30),
...
INSERT INTO material_lots (id, material_id, lot_number, quantity, quantity_remaining, expiry_date, received_at) VALUES
  ('e0000000-0000-0000-0000-000000000001', 'd0000000-0000-0000-0000-000000000001', 'FL-2260-A', 500, 500, '2026-10-15', '2026-03-01'),
  ('e0000000-0000-0000-0000-000000000002', 'd0000000-0000-0000-0000-000000000003', 'BF-2260-A', 300, 180, '2026-08-01', '2026-03-15'),
  ('e0000000-0000-0000-0000-000000000003', 'd0000000-0000-0000-0000-000000000004', 'ML-2260', 30, 15, '2026-04-13', '2026-04-06'),
...
INSERT INTO recipe_ingredients (recipe_id, raw_material_id, quantity, unit, sort_order) VALUES
  ('aa000000-0000-0000-0000-000000000004', 'd0000000-0000-0000-0000-000000000001', 25, 'lbs', 0),
  ('aa000000-0000-0000-0000-000000000004', 'd0000000-0000-0000-0000-000000000005', 12, 'lbs', 1),
  ('aa000000-0000-0000-0000-000000000004', 'd0000000-0000-0000-0000-000000000006', 14, 'lbs', 2),
  ('aa000000-0000-0000-0000-000000000004', 'd0000000-0000-0000-0000-000000000012', 5, 'dozen', 3),
  ('aa000000-0000-0000-0000-000000000004', 'd0000000-0000-0000-0000-000000000013', 0.5, 'lbs', 4),
  ('aa000000-0000-0000-0000-000000000004', 'd0000000-0000-0000-0000-000000000014', 4, 'oz', 5),
  ('aa000000-0000-0000-0000-000000000004', 'd0000000-0000-0000-0000-000000000010', 0.25, 'lbs', 6),
  ('aa000000-0000-0000-0000-000000000004', 'd0000000-0000-0000-0000-000000000015', 20, 'lbs', 7);

-- Recipe Ingredients: Lemon Poppyseed Muffin Top
INSERT INTO recipe_ingredients (recipe_id, raw_material_id, quantity, unit, sort_order) VALUES
  ('aa000000-0000-0000-0000-000000000005', 'd0000000-0000-0000-0000-000000000001', 25, 'lbs', 0),
  ('aa000000-0000-0000-0000-000000000005', 'd0000000-0000-0000-0000-000000000005', 12, 'lbs', 1),
  ('aa000000-0000-0000-0000-000000000005', 'd0000000-0000-0000-0000-000000000006', 15, 'lbs', 2),
  ('aa000000-0000-0000-0000-000000000005', 'd0000000-0000-0000-0000-000000000012', 5, 'dozen', 3),
  ('aa000000-0000-0000-0000-000000000005', 'd0000000-0000-0000-0000-000000000013', 0.5, 'lbs', 4),
  ('aa000000-0000-0000-0000-000000000005', 'd0000000-0000-0000-0000-000000000014', 4, 'oz', 5),
  ('aa000000-0000-0000-0000-000000000005', 'd0000000-0000-0000-0000-000000000010', 0.25, 'lbs', 6),
  ('aa000000-0000-0000-0000-000000000005', 'd0000000-0000-0000-0000-000000000016', 2, 'lbs', 7),
  ('aa000000-0000-0000-0000-000000000005', 'd0000000-0000-0000-0000-000000000017', 1, 'lbs', 8),
  ('aa000000-0000-0000-0000-000000000005', 'd0000000-0000-0000-0000-000000000018', 16, 'oz', 9);

-- Recipe Ingredients: Chocolate Chip Muffin Top
INSERT INTO recipe_ingredients (recipe_id, raw_material_id, quantity, unit, sort_order) VALUES
  ('aa000000-0000-0000-0000-000000000001', 'd0000000-0000-0000-0000-000000000001', 25, 'lbs', 0),
  ('aa000000-0000-0000-0000-000000000001', 'd0000000-0000-0000-0000-000000000005', 12, 'lbs', 1),
  ('aa000000-0000-0000-0000-000000000001', 'd0000000-0000-0000-0000-000000000006', 15, 'lbs', 2),
  ('aa000000-0000-0000-0000-000000000001', 'd0000000-0000-0000-0000-000000000012', 5, 'dozen', 3),
  ('aa000000-0000-0000-0000-000000000001', 'd0000000-0000-0000-0000-000000000013', 0.5, 'lbs', 4),
  ('aa000000-0000-0000-0000-000000000001', 'd0000000-0000-0000-0000-000000000014', 4, 'oz', 5),
  ('aa000000-0000-0000-0000-000000000001', 'd0000000-0000-0000-0000-000000000010', 0.25, 'lbs', 6),
  ('aa000000-0000-0000-0000-000000000001', 'd0000000-0000-0000-0000-000000000011', 18, 'lbs', 7);

-- Recipe Ingredients: Sourdough Loaf
INSERT INTO recipe_ingredients (recipe_id, raw_material_id, quantity, unit, sort_order) VALUES
  ('aa000000-0000-0000-0000-000000000002', 'd0000000-0000-0000-0000-000000000003', 50, 'lbs', 0),
  ('aa000000-0000-0000-0000-000000000002', 'd0000000-0000-0000-0000-000000000010', 1, 'lbs', 1);

-- Recipe Ingredients: Cinnamon Roll
INSERT INTO recipe_ingredients (recipe_id, raw_material_id, quantity, unit, sort_order) VALUES
  ('aa000000-0000-0000-0000-000000000003', 'd0000000-0000-0000-0000-000000000001', 10, 'lbs', 0),
  ('aa000000-0000-0000-0000-000000000003', 'd0000000-0000-0000-0000-000000000005', 5, 'lbs', 1),
  ('aa000000-0000-0000-0000-000000000003', 'd0000000-0000-0000-0000-000000000006', 4, 'lbs', 2),
  ('aa000000-0000-0000-0000-000000000003', 'd0000000-0000-0000-0000-000000000008', 0.5, 'lbs', 3),
  ('aa000000-0000-0000-0000-000000000003', 'd0000000-0000-0000-0000-000000000004', 2, 'gallons', 4),
  ('aa000000-0000-0000-0000-000000000003', 'd0000000-0000-0000-0000-000000000007', 0.25, 'lbs', 5),
  ('aa000000-0000-0000-0000-000000000003', 'd0000000-0000-0000-0000-000000000012', 2, 'dozen', 6);
...
INSERT INTO recipe_version_ingredients (recipe_version_id, raw_material_id, quantity, unit, sort_order) VALUES
  ('bb000000-0000-0000-0000-000000000001', 'd0000000-0000-0000-0000-000000000001', 25, 'lbs', 0),
  ('bb000000-0000-0000-0000-000000000001', 'd0000000-0000-0000-0000-000000000005', 12, 'lbs', 1),
  ('bb000000-0000-0000-0000-000000000001', 'd0000000-0000-0000-0000-000000000006', 15, 'lbs', 2),
  ('bb000000-0000-0000-0000-000000000001', 'd0000000-0000-0000-0000-000000000012', 5, 'dozen', 3),
  ('bb000000-0000-0000-0000-000000000001', 'd0000000-0000-0000-0000-000000000013', 0.5, 'lbs', 4),
  ('bb000000-0000-0000-0000-000000000001', 'd0000000-0000-0000-0000-000000000014', 4, 'oz', 5),
  ('bb000000-0000-0000-0000-000000000001', 'd0000000-0000-0000-0000-000000000010', 0.25, 'lbs', 6),
  ('bb000000-0000-0000-0000-000000000001', 'd0000000-0000-0000-0000-000000000011', 18, 'lbs', 7);

-- Version ingredients for v2 draft (more chocolate chips)
INSERT INTO recipe_version_ingredients (recipe_version_id, raw_material_id, quantity, unit, sort_order) VALUES
  ('bb000000-0000-0000-0000-000000000002', 'd0000000-0000-0000-0000-000000000001', 25, 'lbs', 0),
  ('bb000000-0000-0000-0000-000000000002', 'd0000000-0000-0000-0000-000000000005', 12, 'lbs', 1),
  ('bb000000-0000-0000-0000-000000000002', 'd0000000-0000-0000-0000-000000000006', 15, 'lbs', 2),
  ('bb000000-0000-0000-0000-000000000002', 'd0000000-0000-0000-0000-000000000012', 5, 'dozen', 3),
  ('bb000000-0000-0000-0000-000000000002', 'd0000000-0000-0000-0000-000000000013', 0.5, 'lbs', 4),
  ('bb000000-0000-0000-0000-000000000002', 'd0000000-0000-0000-0000-000000000014', 4, 'oz', 5),
  ('bb000000-0000-0000-0000-000000000002', 'd0000000-0000-0000-0000-000000000010', 0.25, 'lbs', 6),
  ('bb000000-0000-0000-0000-000000000002', 'd0000000-0000-0000-0000-000000000011', 20, 'lbs', 7);

-- Version ingredients for Sourdough v1
INSERT INTO recipe_version_ingredients (recipe_version_id, raw_material_id, quantity, unit, sort_order) VALUES
  ('bb000000-0000-0000-0000-000000000003', 'd0000000-0000-0000-0000-000000000003', 50, 'lbs', 0),
  ('bb000000-0000-0000-0000-000000000003', 'd0000000-0000-0000-0000-000000000010', 1, 'lbs', 1);

-- Version ingredients for Cinnamon Roll v1
INSERT INTO recipe_version_ingredients (recipe_version_id, raw_material_id, quantity, unit, sort_order) VALUES
  ('bb000000-0000-0000-0000-000000000004', 'd0000000-0000-0000-0000-000000000001', 10, 'lbs', 0),
  ('bb000000-0000-0000-0000-000000000004', 'd0000000-0000-0000-0000-000000000005', 5, 'lbs', 1),
  ('bb000000-0000-0000-0000-000000000004', 'd0000000-0000-0000-0000-000000000006', 4, 'lbs', 2),
  ('bb000000-0000-0000-0000-000000000004', 'd0000000-0000-0000-0000-000000000008', 0.5, 'lbs', 3),
  ('bb000000-0000-0000-0000-000000000004', 'd0000000-0000-0000-0000-000000000004', 2, 'gallons', 4),
  ('bb000000-0000-0000-0000-000000000004', 'd0000000-0000-0000-0000-000000000007', 0.25, 'lbs', 5),
  ('bb000000-0000-0000-0000-000000000004', 'd0000000-0000-0000-0000-000000000012', 2, 'dozen', 6);

-- Version ingredients for Blueberry Muffin Top v1
INSERT INTO recipe_version_ingredients (recipe_version_id, raw_material_id, quantity, unit, sort_order) VALUES
  ('bb000000-0000-0000-0000-000000000006', 'd0000000-0000-0000-0000-000000000001', 25, 'lbs', 0),
  ('bb000000-0000-0000-0000-000000000006', 'd0000000-0000-0000-0000-000000000005', 12, 'lbs', 1),
  ('bb000000-0000-0000-0000-000000000006', 'd0000000-0000-0000-0000-000000000006', 14, 'lbs', 2),
  ('bb000000-0000-0000-0000-000000000006', 'd0000000-0000-0000-0000-000000000012', 5, 'dozen', 3),
  ('bb000000-0000-0000-0000-000000000006', 'd0000000-0000-0000-0000-000000000013', 0.5, 'lbs', 4),
  ('bb000000-0000-0000-0000-000000000006', 'd0000000-0000-0000-0000-000000000014', 4, 'oz', 5),
  ('bb000000-0000-0000-0000-000000000006', 'd0000000-0000-0000-0000-000000000010', 0.25, 'lbs', 6),
  ('bb000000-0000-0000-0000-000000000006', 'd0000000-0000-0000-0000-000000000015', 20, 'lbs', 7);

-- Version ingredients for Lemon Poppyseed Muffin Top v1
INSERT INTO recipe_version_ingredients (recipe_version_id, raw_material_id, quantity, unit, sort_order) VALUES
  ('bb000000-0000-0000-0000-000000000007', 'd0000000-0000-0000-0000-000000000001', 25, 'lbs', 0),
  ('bb000000-0000-0000-0000-000000000007', 'd0000000-0000-0000-0000-000000000005', 12, 'lbs', 1),
  ('bb000000-0000-0000-0000-000000000007', 'd0000000-0000-0000-0000-000000000006', 15, 'lbs', 2),
  ('bb000000-0000-0000-0000-000000000007', 'd0000000-0000-0000-0000-000000000012', 5, 'dozen', 3),
  ('bb000000-0000-0000-0000-000000000007', 'd0000000-0000-0000-0000-000000000013', 0.5, 'lbs', 4),
  ('bb000000-0000-0000-0000-000000000007', 'd0000000-0000-0000-0000-000000000014', 4, 'oz', 5),
  ('bb000000-0000-0000-0000-000000000007', 'd0000000-0000-0000-0000-000000000010', 0.25, 'lbs', 6),
  ('bb000000-0000-0000-0000-000000000007', 'd0000000-0000-0000-0000-000000000016', 2, 'lbs', 7),
  ('bb000000-0000-0000-0000-000000000007', 'd0000000-0000-0000-0000-000000000017', 1, 'lbs', 8),
  ('bb000000-0000-0000-0000-000000000007', 'd0000000-0000-0000-0000-000000000018', 16, 'oz', 9);
