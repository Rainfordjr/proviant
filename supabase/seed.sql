...
INSERT INTO production_lines (id, org_id, name, description, is_active, sort_order) VALUES
  ('gg000000-0000-0000-0000-000000000001', 'a0000000-0000-0000-0000-000000000001',
   'Mixer 1', 'Large stand mixer; mornings primarily', true, 0),
  ('gg000000-0000-0000-0000-000000000002', 'a0000000-0000-0000-0000-000000000001',
   'Oven 2', 'Convection bank #2 — bread side', true, 1),
  ('gg000000-0000-0000-0000-000000000003', 'a0000000-0000-0000-0000-000000000001',
...
INSERT INTO batches (
  ...
  ('hh000000-0000-0000-0000-000000000001', 'a0000000-0000-0000-0000-000000000001',
   ...
   'gg000000-0000-0000-0000-000000000001', 'normal', 2, 'c0000000-0000-0000-0000-000000000001',
   'Chocolate chip muffin tops, weekday morning run', 'c0000000-0000-0000-0000-000000000001'),

  ('hh000000-0000-0000-0000-000000000002', 'a0000000-0000-0000-0000-000000000001',
   ...
   'gg000000-0000-0000-0000-000000000002', 'high', 4, 'c0000000-0000-0000-0000-000000000001',
   'Sourdough — Friday-eve pickup orders', 'c0000000-0000-0000-0000-000000000001'),

  ('hh000000-0000-0000-0000-000000000003', 'a0000000-0000-0000-0000-000000000001',
   ...
   'gg000000-0000-0000-0000-000000000001', 'normal', 2, NULL,
   NULL, 'c0000000-0000-0000-0000-000000000001'),

  ('hh000000-0000-0000-0000-000000000004', 'a0000000-0000-0000-0000-000000000001',
   ...
   'gg000000-0000-0000-0000-000000000003', 'normal', 3, NULL,
   'Cinnamon rolls for weekend wholesale', 'c0000000-0000-0000-0000-000000000001'),

  ('hh000000-0000-0000-0000-000000000005', 'a0000000-0000-0000-0000-000000000001',
   ...
   'gg000000-0000-0000-0000-000000000001', 'low', 2, NULL,
   NULL, 'c0000000-0000-0000-0000-000000000001'),

  ('hh000000-0000-0000-0000-000000000006', 'a0000000-0000-0000-0000-000000000001',
   'BATCH-20260518-001', 'planned',
   'c0000000-0000-0000-0000-000000000001', 'aa000000-0000-0000-0000-000000000001', 'bb000000-0000-0000-0000-000000000001',
   'production', 200, '2026-05-18', '2026-05-18T07:00:00+00:00',
   'gg000000-0000-0000-0000-000000000001', 'urgent', 3, 'c0000000-0000-0000-0000-000000000001',
...
INSERT INTO batch_product_allocations (batch_id, product_id, quantity, unit) VALUES
  ('hh000000-0000-0000-0000-000000000001', 'c0000000-0000-0000-0000-000000000001', 100, 'each'),
  ('hh000000-0000-0000-0000-000000000002', 'c0000000-0000-0000-0000-000000000002', 24, 'loaves'),
  ('hh000000-0000-0000-0000-000000000003', 'c0000000-0000-0000-0000-000000000004', 100, 'each'),
  ('hh000000-0000-0000-0000-000000000004', 'c0000000-0000-0000-0000-000000000003', 60, 'each'),
  ('hh000000-0000-0000-0000-000000000005', 'c0000000-0000-0000-0000-000000000005', 100, 'each'),
  ('hh000000-0000-0000-0000-000000000006', 'c0000000-0000-0000-0000-000000000001', 200, 'each');
